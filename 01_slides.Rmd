...
.font160[
<br><br><br><br>
How does this OPA help to stop the raise of alternative facts?
...
- Both claim to report on the same fact (policy estimate)
...
## Examples of specific knowledge recorded in the OPA:
- How to use the results main result in an adjusted CBA (add printout of table 5)
   - How to compute costs  
   - How to compute benefits  
   - What are the relevant prevalence rates
   - What are the relevant take-up rates
